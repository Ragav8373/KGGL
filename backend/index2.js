...
app.post("/webinar-form",(req,res)=>{
  ...
  const query =`INSERT INTO webinar (
    name, 
    email, 
    phoneNumber, 
    companyName, 
 ...
 db.query(query,[username,email,phoneNumber,companyName,designation,state,city],(error,result)=>{
  if(error){
    ...
    const mailOptions = {
      ...
      text: `Hello ${username},\n\nThank you for registering with Webinar!\n\nBest Regards,\nLMS Team`,
    };
