  ...
  return (
    <div className='container-fluid bgclrfooter mt-5 py-3'>
      <div className='container'>
        <div className='footer-wrapper px-4 py-4'>
          <div className='row justify-content-center text-center'>
            <div className='col-12 col-md-4 d-flex flex-column align-items-center mb-3'>
              <a href="mailto:info@kggeniuslabs.com" className='footer-link'>
            ...
            <div className='col-12 col-md-4 d-flex flex-column align-items-center mb-3'>
              <a href="tel:9363466094" className='footer-link'>
