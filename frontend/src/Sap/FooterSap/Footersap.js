    ...
    <div className="container-fluid pt-5 footerbg px-5 ">
      <div className="row">
          ...
          <p>
            ...
            >
              ...
              <span className="d-none d-md-block">
                Ideaspace Business Center, Millennium Executive Tower, Sheikh
        ...
        <div className="col-sm-4 col-lg-3">
          ...
          <div className="d-flex flex-column justify-content-center">
            ...
            <div className="pb-4">
              ...
              <a href="https://www.instagram.com/kggeniuslabs/">
                <FontAwesomeIcon
                  icon={faInstagram}
                  className="text-white mx-2"
                ></FontAwesomeIcon>
              </a>
              <a href="https://www.linkedin.com/company/kg-geniuslabs/">
                <FontAwesomeIcon
                  icon={faLinkedin}
                  className="text-white mx-2"
                ></FontAwesomeIcon>
              </a>
              <a href="https://x.com/KGGeniusLabs">
                <FontAwesomeIcon
        ...
        <p className="text-center py-1">
          Copyright © {year} KGGL. All Right Reserved.
        </p>
      </div>
    </div>
  );
