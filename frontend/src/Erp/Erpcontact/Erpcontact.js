...
const [requestType, setRequestType] = useState(""); 
  ...
  return (
    <div className="container-fluid frmcontacts" id="ERPcontact">
      <ToastContainer />
      <div className="container">
        <div className="row  py-4">
          <div className="col-sm-12 col-md-6 d-flex align-items-center justify-content-center">
            <div className="textcontact text-light">
              <h1 className="text-center"><b>Book a Demo </b>to discover how our KG Genius ERP can solve your business challenges.</h1>
            </div>
          </div>
